...
| Risk sensitivities engine (DV01, CS01, FX Delta) | `20260214-171701-add-risk-sensitivities-engine-dv01-cs01-fx-delta-184e81cb.md` | engine | **Planned** | New high-priority request; no implementation progress updates yet. |
