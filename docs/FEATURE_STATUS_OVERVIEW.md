...
| Deterministic curve calibration/interpolation framework | `20260214-171702-add-deterministic-curve-calibration-and-interpolation-framework-e170013e.md` | models | **In Progress** | Deterministic deposit/swap bootstrap, diagnostics, and CSV quote-loading support are implemented; richer interpolation modes and broader curve coverage remain open. |
| Callable bond pricing with short-rate lattice | `20260214-171703-add-callable-bond-pricing-with-short-rate-lattice-d9a34f9b.md` | products | **In Progress** | Initial callable fixed-rate bond lattice pricing and OAS solver are implemented with tests; richer Hull-White calibration/exercise diagnostics remain open. |
| Collateral and CSA discounting layer | `20260214-171704-add-collateral-and-csa-discounting-layer-63e39814.md` | engine | **In Progress** | Deterministic CSA engine, netting-set aggregation, and CSV loader wiring are implemented; richer collateral dynamics remain open. |
